...
public class Actividad1_8 {
    public static void main(String[] args) throws IOException {
        ...
        p.redirectOutput(ProcessBuilder.Redirect.INHERIT);// Redirigir la salida estándar a la consola
        ...
        p.redirectInput(ProcessBuilder.Redirect.from(fin));        // Redirigir la entrada desde un archivo
